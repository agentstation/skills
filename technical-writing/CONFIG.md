...
It also checks the first 16 KiB of each discovered file for a generated
artifact marker. The recognized forms include:

- `@generated` and `<auto-generated>` declarations.
- generated-file notices that also say `DO NOT EDIT`.
- Doxygen and Javadoc generation headers.
- HTML generator metadata for Docutils, Doxygen, Javadoc, JSDoc, MkDocs,
  rustdoc, Sphinx, and TypeDoc.

The detector does not exclude prose that only discusses generated output.
